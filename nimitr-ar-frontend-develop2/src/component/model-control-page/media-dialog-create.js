...
const MediaDialogCreate = ({ status, onCloseDialog, refetch, projectId, markerSelect }) => {
            ...
            <Box component={'form'} onSubmit={handleSubmitCreateContent}>
                ...
                <DialogContent>
                    ...
                    <Grid container sx={{ minWidth: { lg: '800px', xs: '400px' } }}>
                        ...
                        <Grid xs={12} sx={{ p: 1, mt: { lg: 0, xs: 3 }, }}>
                            <Stack>
                ...
                <DialogActions sx={{ p: 2 }}>
                    <Button type='submit' variant="contained" endIcon={<Publish />} sx={{ fontWeight: 700 }} disabled={contentState?.name && mediaFile?.length != 0 ? false : true}>Submit</Button>
                </DialogActions>
            </Box>
        </Dialog >
    );
};
export default MediaDialogCreate
